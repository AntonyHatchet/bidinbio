...
app.get("/auction/:mediaId", passportConfig.isAuthenticated, auctionController.getAuction);
app.delete("/auction/:mediaId", passportConfig.isAuthenticated, auctionController.deleteAuction);
